...
export const HomeAPI=createContext()
const Blogapi = (props) => {
...
{
  "Title" : " Swaran Ghar: Actresses who REJECTED Sangita Ghoshs role in the show",
  "CategoryName"  : "Bollywood",
  "PublishedDate" : "Januaury 14 2022",
  "ImageAsset"    : "https://st1.bollywoodlife.com/wp-content/uploads/2022/05/Swaran-Ghar1-1.png?impolicy=Medium_Widthonly&w=303",
  "BlogContent"   : "Actresses who REJECTED Sangita Ghoshs role in the show"
},
{
...
},
{
  ...
  "BlogContent"   : "karan johar hired new chefs for food prparation for his 50th birthday"
},
{
  ...
  "BlogContent"   : "Aamir khan launches trailer for new upcoming film"
}

    ])
  return (
    <div>
      <HomeAPI.Provider value={[data,setData]}>
        {props.children }
      </HomeAPI.Provider>
    </div>
  )
