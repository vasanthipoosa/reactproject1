...
const Cricketapi = (props) => {
  const [dataCric, setDataCric] = useState([
    ...
    "description": "Virender Sehwag Bets on RCBs Virat Kohli coming good against LSG in Eliminator match of IPL 2022.",
    ...
    "content": "McLaren boss Zak Brown admitted that Daniel Ricciardo isnt living up to the teams expectations, and is struggling in Lando Norris’ shadow. \r\nRicciardo’s move to McLaren has not been a success for e… [+2758 chars]"
    },
    {
    "source": {
    "id": null,
    ...
    "content": "Indian Team for SA T20 - IND vs SA Live Updates: Indias IPL 2022 stars may be fit and going all guns blazing at the IPL 2022 but BCCI wants them to prove fitness. The Indian board has asked the KL R… [+3961 chars]"
    },
    {
    "source": {
    "id": null,
